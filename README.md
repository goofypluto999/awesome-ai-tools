...
- [AimVantage](https://aimvantage.uk) - AI job preparation tool that generates company intel, tailored cover letters, mock interview questions, and CV fit analysis from a CV + job URL in 90 seconds.
